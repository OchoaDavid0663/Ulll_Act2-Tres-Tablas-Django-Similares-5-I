...
Selecciona la opción que apunte a tu entorno virtual (por ejemplo, ./.venv/Scripts/python.exe en Windows o ./.venv/bin/python en macOS/Linux).
...
Crear migraciones (si hay cambios pendientes):
code
Bash
python manage.py makemigrations
